 ...
 * passing to the {@link winkit.android.core.CoreController.ParsedResponse} the localizedErrorMessage.
 *
...
public abstract class CoreDefaultErrorResponseListener<T> extends CoreResponseListener<T> {
     ...
     * Constructor
     *
     * @param response the {@link winkit.android.core.CoreController.ParsedResponse} response
     */
